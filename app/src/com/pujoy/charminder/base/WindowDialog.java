...
public abstract class WindowDialog extends WindowBase{
	...
	public void create(){
		...
		ValueAnimator aUpperCicleY = ObjectAnimator.ofFloat(mUpperCircle, "y",
				mLayoutParams.getHeight()/2 - mLayoutParams.getWidth()/2, 0);
		aUpperCicleY.setDuration(ANIMATION_DURATION);
		ValueAnimator aLowerCicleY = ObjectAnimator.ofFloat(mLowerCircle, "y",
				mLayoutParams.getHeight()/2, mLayoutParams.getHeight() - mLayoutParams.getWidth()/2);
		aLowerCicleY.setDuration(ANIMATION_DURATION);
		ValueAnimator aMiddleFillerHeight = ObjectAnimator.ofFloat(mMiddleFiller, "scaleY",
				0, 1);
		aMiddleFillerHeight.setDuration(ANIMATION_DURATION);
		ValueAnimator aOkCircleY = ObjectAnimator.ofFloat(mOkCircle, "y",
				mLayoutParams.getHeight()/2-mOkCircle.getLayoutParams().height, 0);
		aOkCircleY.setDuration(ANIMATION_DURATION);
			
		
		ValueAnimator aCancelCircleY = ObjectAnimator.ofFloat(mCancelCircle, "y",
				mLayoutParams.getHeight()/2-mCancelCircle.getLayoutParams().height, 0);
	...
	public void remove(){
		...
		ValueAnimator aUpperCicleY = ObjectAnimator.ofFloat(mUpperCircle, "y",
				0, mLayoutParams.getHeight()/2 - mLayoutParams.getWidth()/2);
		aUpperCicleY.setDuration(ANIMATION_DURATION);
		ValueAnimator aLowerCicleY = ObjectAnimator.ofFloat(mLowerCircle, "y",
				mLayoutParams.getHeight() - mLayoutParams.getWidth()/2, mLayoutParams.getHeight()/2);
		aLowerCicleY.setDuration(ANIMATION_DURATION);
		ValueAnimator aMiddleFillerHeight = ObjectAnimator.ofFloat(mMiddleFiller, "scaleY",
				1, 0);
		aMiddleFillerHeight.setDuration(ANIMATION_DURATION);
		ValueAnimator aOkCircleY = ObjectAnimator.ofFloat(mOkCircle, "y",
				0, mLayoutParams.getHeight()/2-mOkCircle.getLayoutParams().height);
		aOkCircleY.setDuration(ANIMATION_DURATION);
			
		ValueAnimator aCancelCircleY = ObjectAnimator.ofFloat(mCancelCircle, "y",
				0, mLayoutParams.getHeight()/2-mCancelCircle.getLayoutParams().height);
		aCancelCircleY.setDuration(ANIMATION_DURATION);
		aCancelCircleY.start();
	...
	protected void onInitialize(boolean bFullUpperCircle){
    	...
    	mUpperCircle = new ImageView(mCon);
    	mLowerCircle = new ImageView(mCon);
    	mMiddleFiller = new ImageView(mCon);
		mMainView.layout(0, 0, mLayoutParams.getWidth(), mLayoutParams.getHeight());
    	mUpperCircle.setLayoutParams(new LayoutParams(mLayoutParams.getWidth(), mLayoutParams.getWidth()/2));
		mMiddleFiller.setY(mLayoutParams.getWidth()/2);
		mMiddleFiller.setLayoutParams(new LayoutParams(mLayoutParams.getWidth(), mLayoutParams.getHeight() - mLayoutParams.getWidth()));
    	mLowerCircle.setLayoutParams(new LayoutParams(mLayoutParams.getWidth(), mLayoutParams.getWidth()/2));
    	mUpperCircle.setImageResource(bFullUpperCircle? R.drawable.semi_circle_full:
    	...
    	mOkCircle = new TextView(mCon);
    	mOkCircle.setTextSize(TypedValue.COMPLEX_UNIT_SP, 16);
    	mOkCircle.setGravity(Gravity.CENTER);
    	mOkCircle.setTextColor(Constants.COLOR_DARKBLUE);
    	mOkCircle.setText(mCon.getString(R.string.ok));
    	mOkCircle.setBackgroundResource(R.drawable.small_circle);
    	mOkCircle.setLayoutParams(new LayoutParams((int)dpToPx(73.39249146757679f), (int)dpToPx(73.39249146757679f)));
    	mOkCircle.setX(0);
    	...
    	mCancelCircle = new TextView(mCon);
    	mCancelCircle.setTextSize(TypedValue.COMPLEX_UNIT_SP, 16);
    	mCancelCircle.setGravity(Gravity.CENTER);
    	mCancelCircle.setTextColor(Constants.COLOR_DARKBLUE);
    	mCancelCircle.setText(mCon.getString(R.string.cancel));
    	mCancelCircle.setBackgroundResource(R.drawable.small_circle);
    	mCancelCircle.setLayoutParams(new LayoutParams((int)dpToPx(73.39249146757679f), (int)dpToPx(73.39249146757679f)));
    	mCancelCircle.setX(mLayoutParams.getWidth() - mCancelCircle.getLayoutParams().width);
