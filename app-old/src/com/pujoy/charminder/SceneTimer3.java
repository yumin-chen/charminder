...
public class SceneTimer3 extends Scene implements OnClickListener{
	...
	public void Create(Context c){
    	...
    	tvHour.setX(wmParams.width/2- dpToPx(62));
    	tvHour.setText(c.getString(R.string.everyhour));
    	...
    	tvTitle.setText(c.getString(R.string.title_timer3));
	...
	private void Ok(){
		...
		newReminder.time_to_remind.set(Calendar.MINUTE, 
		...
		newReminder.note=tvDigits[0].getText().toString()+tvDigits[1].getText();
		...
		MainActivity.PushFloatingBubble(c.getString(R.string.bubble_add_reminder) +
				c.getString(R.string.bubble_timer3) + newReminder.note + 
				c.getString(R.string.minute) + c.getString(R.string.bubble_timer2));
	}
